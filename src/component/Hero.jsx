  ...
  return (
    <div id='home' className='mt-5 lg:mt-20 w-full overflow-hidden'>
      <div className='flex flex-col items-center gap-8.75'>
        ...
        <h1 className='text-center text-[40px] lg:text-[80px] w-[90%] lg:w-[70%] font-medium -my-2 lg:my-1'><span className='bg-linear-to-l from-[#DA7C25] to-[#B923E1] bg-clip-text text-transparent'>I'm Ibrahim Hosen,</span> frontend devoloper based in BD.</h1>
